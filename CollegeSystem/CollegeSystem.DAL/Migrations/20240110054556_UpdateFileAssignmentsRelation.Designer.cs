...
namespace CollegeSystem.DAL.Migrations
{
    ...
    [Migration("20240110054556_UpdateFileAssignmentsRelation")]
    partial class UpdateFileAssignmentsRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.LectureAssignmentAnswer", b =>
                {
                    b.HasBaseType("CollegeSystem.DAL.Models.AssignmentAnswer");
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.File", b =>
                {
                    b.HasOne("CollegeSystem.DAL.Models.AssignmentAnswer", "AssignmentAnswer")
                        .WithMany("File")
                    ...
                    b.HasOne("CollegeSystem.DAL.Models.Course", "Course")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_Courses_Files");
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.LectureAssignment", b =>
                {
                    b.HasOne("CollegeSystem.DAL.Models.Assignment", null)
                        .WithOne()
                        .HasForeignKey("CollegeSystem.DAL.Models.LectureAssignment", "AssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.SectionAssignment", b =>
                {
                    b.HasOne("CollegeSystem.DAL.Models.Assignment", null)
                        .WithOne()
                        .HasForeignKey("CollegeSystem.DAL.Models.SectionAssignment", "AssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.LectureAssignmentAnswer", b =>
                {
                    b.HasOne("CollegeSystem.DAL.Models.AssignmentAnswer", null)
                        .WithOne()
                        .HasForeignKey("CollegeSystem.DAL.Models.LectureAssignmentAnswer", "AssignmentAnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
