...
namespace CollegeSystem.DAL.Migrations
{
    ...
    [Migration("20240110230000_GetRidOfFileRelations")]
    partial class GetRidOfFileRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long?>("SectionAssignmenAnswertId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CollegeSystem.DAL.Models.Image", b =>
                {
                    b.HasOne("CollegeSystem.DAL.Models.Course", "Course")
                        .WithOne("Img")
                        .HasForeignKey("CollegeSystem.DAL.Models.Image", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("CollegeSystem.DAL.Models.Student", "Student")
                        .WithOne("Img")
                        .HasForeignKey("CollegeSystem.DAL.Models.Image", "StudentId");
